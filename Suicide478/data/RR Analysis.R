...
# This is the file where I calculated the relative risks based on raw data and 
# generated the csv files for year 2011 to 2015; the actual server and ui didn't use 
# this file but this is put here just for reference of how I calculated the relative risk
# I didn't upload the raw data such as 2011.csv because it is way too large us github
# storage and would slow down the whole web page if I load them.

# Please don't run this file because it doesn't have the data in the folder. And I 
# used this file to generate 5 files but only used the same code with different file paths 
# so that's why the code below doesn't have the process of 5 files but one.
