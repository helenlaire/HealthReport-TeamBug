...
data_2015 <- read.csv("Prevention-Mengjiao/data/editedData_2015.csv", stringsAsFactors = FALSE)
...
mental_data_2015 <- mental_health_plan %>%
...
data_2014 <- read.csv("Prevention-Mengjiao/data/editedData_2014.csv", stringsAsFactors = FALSE)
...
mental_data_2014 <- mental_health_plan %>%
  left_join(mental_afford, by = "MENTHLTH") %>%
  left_join(mental_exercise, by = "MENTHLTH") %>%
  left_join(mental_emotional_support, by = "MENTHLTH") %>%
  left_join(mental_satisfaction, by = "MENTHLTH") %>%
...
data_2013 <- read.csv("Prevention-Mengjiao/data/editedData_2013.csv", stringsAsFactors = FALSE)
...
mental_data_2013 <- mental_health_plan %>%
  left_join(mental_afford, by = "MENTHLTH") %>%
  left_join(mental_exercise, by = "MENTHLTH") %>%
  left_join(mental_emotional_support, by = "MENTHLTH") %>%
  left_join(mental_satisfaction, by = "MENTHLTH") %>%
...
data_2011 <- read.csv("Prevention-Mengjiao/data/editedData_2011.csv", stringsAsFactors = FALSE)
...
mental_data_2011 <- mental_health_plan %>%
  left_join(mental_afford, by = "MENTHLTH") %>%
  left_join(mental_exercise, by = "MENTHLTH") %>%
  # left_join(mental_emotional_support, by = "MENTHLTH") %>%
  left_join(mental_satisfaction, by = "MENTHLTH") %>%
