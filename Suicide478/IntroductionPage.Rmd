...
4) Does the $15 minimum wage positively affect poverty rate?</br>
5) What is the possible external factor related to suicide rate in national level? Higher living standard means lower suicide rates? Better health system means lower suicide rates? Higher unemployment rates means higher suicide rates?
